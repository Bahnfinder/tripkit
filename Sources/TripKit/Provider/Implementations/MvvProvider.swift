...
public class MvvProvider: AbstractEfaWebProvider {
    ...
    public init() {
        ...
        styles = [
            ...
            "T21": LineStyle(shape: .rect, backgroundColor: LineStyle.parseColor("#C28C38"), foregroundColor: LineStyle.white),
            ...
            "BN45": LineStyle(shape: .rect, backgroundColor: LineStyle.parseColor("#1A181B"), foregroundColor: LineStyle.parseColor("#FCBB10"), borderColor: LineStyle.parseColor("#FCBB10")),
